...
const languageUi: Record<LanguageMode, VoiceUiCopy> = {
  ...
  Hindi: {
    ...
    response: '480 मिलीसेकंड में जवाब',
    nowSpeaking: 'अभी बोल रहे हैं',
  ...
  Kannada: {
    preview: 'ಲೈವ್ ಪ್ರಿವ್ಯೂ',
    response: '480 ಮಿಲಿಸೆಕೆಂಡ್‌ನಲ್ಲಿ ಪ್ರತಿಕ್ರಿಯೆ',
    nowSpeaking: 'ಈಗ ಮಾತನಾಡುತ್ತಾರೆ',
  ...
  Tamil: {
    ...
    response: '480 மில்லி விநாடியில் பதில்',
    nowSpeaking: 'இப்போது பேசுகிறார்',
  ...
  Telugu: {
    ...
    response: '480 మిల్లీసెకన్లలో సమాధానం',
    nowSpeaking: 'ఇప్పుడు మాట్లాడుతున్నారు',
...
const voiceAgents = [
  {
    ...
    scripts: {
      ...
      Hindi: {
        ...
        agent: 'हाँ रोहन जी, मैं आपके पास वाले शोरूम में टेस्ट ड्राइव का समय बुक कर देती हूँ और कन्फर्मेशन भेज देती हूँ।',
        prompt: '“नमस्ते रोहन जी, आपने नेक्सॉन ईवी टेस्ट ड्राइव में रुचि दिखाई थी। मैं आपके लिए नज़दीकी शोरूम और सही समय कन्फर्म कर सकती हूँ।”',
        voiceLine: 'हिन्दी में नेक्सॉन ईवी टेस्ट ड्राइव बुकिंग संभालती है।',
        outcome: 'बुकिंग पूरी · शोरूम को अलर्ट',
        context: 'ऑटो डीलर हिन्दी कॉल',
      },
      Hinglish: {
      ...
      Kannada: {
        ...
        agent: 'ಹೌದು ರೋಹನ್ ಅವರೇ, ನಿಮ್ಮ ಹತ್ತಿರದ ಶೋರೂಮ್‌ನಲ್ಲಿ ಟೆಸ್ಟ್ ಡ್ರೈವ್ ಸಮಯವನ್ನು ಬುಕ್ ಮಾಡಿ ದೃಢೀಕರಣ ಕಳುಹಿಸುತ್ತೇನೆ.',
        prompt: '“ನಮಸ್ಕಾರ ರೋಹನ್ ಅವರೇ, ನೀವು ನೆಕ್ಸಾನ್ ಇವಿ ಟೆಸ್ಟ್ ಡ್ರೈವ್ ಬಗ್ಗೆ ಆಸಕ್ತಿ ತೋರಿಸಿದ್ದೀರಿ. ಹತ್ತಿರದ ಶೋರೂಮ್ ಮತ್ತು ಸರಿಯಾದ ಸಮಯವನ್ನು ಕನ್‌ಫರ್ಮ್ ಮಾಡಬಹುದು.”',
        voiceLine: 'ಕನ್ನಡದಲ್ಲಿ ನೆಕ್ಸಾನ್ ಇವಿ ಟೆಸ್ಟ್ ಡ್ರೈವ್ ಬುಕಿಂಗ್ ನೋಡಿಕೊಳ್ಳುತ್ತಾರೆ.',
        outcome: 'ಬುಕಿಂಗ್ ಪೂರ್ಣ · ಶೋರೂಮ್‌ಗೆ ಅಲರ್ಟ್',
        context: 'ಬೆಂಗಳೂರು ಶೋರೂಮ್ ಕನ್ನಡ ಕರೆ',
      },
      Tamil: {
        customer: 'இந்த சனிக்கிழமை நெக்சான் ஈவி டெஸ்ட் டிரைவுக்கு வரலாமா?',
        agent: 'ஆம் ரோஹன், உங்களுக்கு அருகிலுள்ள ஷோரூமில் டெஸ்ட் டிரைவ் நேரத்தை பதிவு செய்து உறுதிப்படுத்தல் அனுப்புகிறேன்.',
        prompt: '“வணக்கம் ரோஹன், நீங்கள் நெக்சான் ஈவி டெஸ்ட் டிரைவில் ஆர்வம் காட்டியிருந்தீர்கள். அருகிலுள்ள ஷோரூமையும் சரியான நேரத்தையும் கன்பர்ம் செய்யலாம்.”',
        voiceLine: 'தமிழில் நெக்சான் ஈவி டெஸ்ட் டிரைவ் புக்கிங்கை உறுதிப்படுத்துகிறார்.',
        outcome: 'புக்கிங் முடிந்தது · ஷோரூமுக்கு அலர்ட்',
        context: 'சென்னை ஷோரூம் தமிழ் அழைப்பு',
      },
      Telugu: {
        customer: 'ఈ శనివారం నెక్సాన్ ఈవీ టెస్ట్ డ్రైవ్‌కు రావచ్చా?',
        agent: 'అవును రోహన్ గారు, మీ దగ్గరలోని షోరూమ్‌లో టెస్ట్ డ్రైవ్ టైమ్‌ను బుక్ చేసి కన్ఫర్మేషన్ పంపిస్తాను.',
        prompt: '“నమస్కారం రోహన్ గారు, మీరు నెక్సాన్ ఈవీ టెస్ట్ డ్రైవ్‌పై ఆసక్తి చూపించారు. దగ్గరలోని షోరూమ్ మరియు సరైన సమయాన్ని కన్ఫర్మ్ చేయగలను.”',
        voiceLine: 'తెలుగులో నెక్సాన్ ఈవీ టెస్ట్ డ్రైవ్ బుకింగ్‌ను చూసుకుంటారు.',
        outcome: 'బుకింగ్ పూర్తైంది · షోరూమ్‌కు అలర్ట్',
  ...
  },
  {
    ...
    scripts: {
      ...
      Hindi: {
        customer: 'क्या मेरा बिज़नेस लोन इस महीने रिन्यू हो सकता है?',
        agent: 'हाँ प्रिया जी, मैं आपकी एलिजिबिलिटी चेक करके पसंद की राशि कन्फर्म कर देता हूँ और एडवाइज़र की कॉल शेड्यूल कर देता हूँ।',
        prompt: '“नमस्ते प्रिया जी, आपका लोन रिन्यूअल विंडो खुला है। मैं एलिजिबिलिटी, राशि की रेंज और कॉल का सही समय कन्फर्म कर सकता हूँ।”',
        voiceLine: 'हिन्दी में लोन रिन्यूअल की एलिजिबिलिटी शांत ढंग से चेक करता है।',
        outcome: 'एलिजिबल · एडवाइज़र कॉल',
        context: 'दिल्ली एनसीआर हिन्दी फाइनेंस कॉल',
      },
      Hinglish: {
  ...
  },
  {
    ...
    scripts: {
      ...
      Hindi: {
        customer: 'क्या कल सुबह डॉक्टर की अपॉइंटमेंट मिल सकती है?',
        agent: 'हाँ अनन्या जी, मैं सुबह 10:30 की अपॉइंटमेंट बुक कर देती हूँ, पता भेज देती हूँ और नर्स डेस्क को अलर्ट कर देती हूँ।',
        prompt: '“नमस्ते अनन्या जी, मैं कल की डॉक्टर अपॉइंटमेंट कन्फर्म करके तैयारी के निर्देश भेज सकती हूँ।”',
        voiceLine: 'हिन्दी में डॉक्टर अपॉइंटमेंट को विनम्रता से कन्फर्म करती है।',
        outcome: 'अपॉइंटमेंट बुक · नर्स डेस्क अलर्ट',
      ...
      Tamil: {
        customer: 'நாளை காலை டாக்டர் அபாயின்ட்மென்ட் கிடைக்குமா?',
        agent: 'ஆம் அனன்யா, காலை 10:30 அபாயின்ட்மென்டை பதிவு செய்து முகவரியை அனுப்பி நர்ஸ் டெஸ்க்கு அலர்ட் செய்கிறேன்.',
        prompt: '“வணக்கம் அனன்யா, நாளைய டாக்டர் அபாயின்ட்மென்டை உறுதிப்படுத்தி தயாரிப்பு வழிமுறைகளை அனுப்பலாம்.”',
        voiceLine: 'தமிழில் டாக்டர் அபாயின்ட்மென்டை மென்மையாக உறுதிப்படுத்துகிறார்.',
        outcome: 'அபாயின்ட்மென்ட் புக் · நர்ஸ் டெஸ்க் அலர்ட்',
        context: 'கிளினிக் தமிழ் வரவேற்பு அழைப்பு',
      },
      Telugu: {
        customer: 'రేపు ఉదయం డాక్టర్ అపాయింట్‌మెంట్ దొరుకుతుందా?',
        agent: 'అవును అనన్య గారు, ఉదయం 10:30 అపాయింట్‌మెంట్‌ను బుక్ చేసి అడ్రస్ పంపి నర్స్ డెస్క్‌కు అలర్ట్ చేస్తాను.',
        prompt: '“నమస్కారం అనన్య గారు, రేపటి డాక్టర్ అపాయింట్‌మెంట్‌ను కన్ఫర్మ్ చేసి సిద్ధం కావాల్సిన సూచనలు పంపగలను.”',
        voiceLine: 'తెలుగులో డాక్టర్ అపాయింట్‌మెంట్‌ను మృదువుగా కన్ఫర్మ్ చేస్తారు.',
        outcome: 'అపాయింట్‌మెంట్ బుక్ · నర్స్ డెస్క్ అలర్ట్',
        context: 'క్లినిక్ తెలుగు ఫ్రంట్ డెస్క్ కాల్',
      },
    } satisfies Record<LanguageMode, VoiceScript>,
  },
]
